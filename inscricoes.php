...
<html lang="pt">
			<head>
				...
				<meta name="description" content="Sistema de Gestao da Escola rei dos Reis">
				<meta name="author" content="Haggy Manjolo">
				<meta name="viewport" content="width=device-width, initial-scale=1">
				    

				<title>Rei dos Reis</title>
						...
						<div class="panel-body">
				          ...
				          <div class="col-sm-12">
							...
							<div class="col-sm-12">
							  ...
							  <div class="col-sm-6">
								Mae:
								  <input type="text" class="input-sm form-control" name="mae" maxlength="35" placeholder="Nome da mae" required="">
								</div>
							...
							<div class="col-sm-12">
							  ...
							  <div class="col-sm-4">
								Contacto:
								  <input type="text" class="input-sm form-control" name="contactoEncarregado" maxlength="9" placeholder="Contacto" required="">
								</div>
