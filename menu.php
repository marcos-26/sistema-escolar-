      ...
      <div class="panel navbar with-nav-tabs navbar-fixed-top" >
        <div class="panel-heading" style="background-color: #3197ef;">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse">
              ...
              <span class="icon-bar"></span>
                ...
                <a class="navbar-brand" href="inicio.php"><span style="color: #fff; font-size: 25px; "><label> Rei dos Reis</label></span></span></a>
          </div> 
          <div class="navbar-collapse collapse" id="navbar-collapse">
                ...
                ?>
    				      <li ><a href="mensagens.php"><span class="glyphicon glyphicon-envelope" style="color: #ffffff;font-size:18px;"> Contacte-nos</span></a></li>
                  <?php 
                      } 
                  ...
                  ?>
                  <li><a href="" data-toggle="modal" data-target="#verNotificacoes"><span class="glyphicon glyphicon-bell " style="color: #ffffff;font-size:18px;"> Notificações </span><span class="badge"><?php echo ' '.mysql_num_rows($novasNotificacoes); ?></span></a></li>     
                </ul>
