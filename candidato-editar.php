    ...
    <div class="panel panel-default panel-table">
        ...
        <form class="form-horizontal" name="cadastrarEstudante" method="POST" >
          ...
          <div class="col-sm-12">
			  ...
			  <div class="col-sm-4">
				Contacto:
				  <input type="text" class="input-sm form-control" name="contactoCandidato" value="<?php echo $resultado['contacto']?>" placeholder="Contacto" required="">
				</div>
				<div class="col-sm-4">
				Data de Nascimento:
