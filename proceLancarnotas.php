...
try {
	$sql = "UPDATE `tabela_notas` SET `Teste1` = '$texte1', `Teste2` = '$texte2', `Trabalho1` = '$Trabalho1', `Trabalho2` = '$Trabalho2', `TP` = '$TP', `DataModificacao` = NOW() WHERE `tabela_notas`.`idNota` = $idNota";
	...
	try {
		$sql = "INSERT INTO `tabela_notas` (`idEstudante`, `id_Relacao_Disciplina`, `Teste1`, `Teste2`, `Trabalho1`, `Trabalho2`, `TP`, `Trimestre`, `DataCadastro`, `DataModificacao`) VALUES ('$idEstudante', '$id_Relacao', '$texte1', '$texte2', '$Trabalho1', '$Trabalho2', '$TP', '$Trimestre', NOW(),null)";
		$query=mysql_query($sql);	
		if ($query) {
		      $_SESSION['mensagem'] = "
													<p></p>
