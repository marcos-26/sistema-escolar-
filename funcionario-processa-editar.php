    ...
    $idUsuario= $_POST['idUsuario'];
			...
			if($senha === $confirmacao){
				...
				//Inserindo os dados do formulario usercadastrar na tabela usuarios
				 $inserir = mysql_query("UPDATE funcionario set Nome='$Nome',Apelido='$Apelido', Email='$Email', Contacto='$Contacto', DOB='$DOB', BI='$BI', Estado='$Estado', Naturalidade='$Naturalidade', Bairro='$Bairro', Pais='$Pais', Sexo='$Sexo', dataMod=NOW() WHERE ID = '$ID'");
