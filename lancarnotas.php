...
<div class="col col-lg-H col-md-H col-sm-H haggy">
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
              <p>
                	<div class="divH"><label>Notas de Frequencia -> </label><?php echo' '; echo $linhas['id_Disciplina']; echo' ';  echo $linhas['nomeTurma'];?> -> <?php echo $Trimestre;?></div>
              </p> 
        </div>
			...
			<div class="table-responsive">
				...
				while($linhas2 = mysql_fetch_array($resultado)){
					...
					echo "<tr>";
					echo "<td><input type='hidden' size='2' maxlength='2' class='form-control' id='idEstudante' name='idEstudante' value='$idEstudante'" .">".$linhas2['nome']." ".$linhas2['apelido']."</td>";
					echo "<td><input type='text' size='2' maxlength='2' class='form-control' id='texte1' name='texte1' value='".$m->T1."'" ."></td>";
					echo "<td><input type='text' size='2' maxlength='2' class='form-control' id='texte2' name='texte2' value='".$m->T2."'" ."></td>";
					echo "<td>".$m->MT."</td>";
					echo "<td><input type='text' size='2' maxlength='2' class='form-control' id='trab1' name='trab1' value='".$m->Trab1."'" ."></td>";
					echo "<td><input type='text' size='2' maxlength='2' class='form-control' id='trab2' name='trab2' value='".$m->Trab2."'" ."></td>";
					echo "<td>$m->MTrab</td>";
					echo "<td><input type='text' size='2' maxlength='2' class='form-control' id='TP' name='TP' value='".$m->TP."'>
					<input type='hidden' size='2' maxlength='2' class='form-control' id='idNota' name='idNota' value='".$m->idNota."'
					" ."></td>";
					echo "<td>".$m->M."</td>"; 
