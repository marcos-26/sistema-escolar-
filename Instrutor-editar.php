...
<?php
 ...
 session_start();
	...
	$_SESSION['ID']= $ID;
	//Executa consulta
	$result = mysql_query("SELECT * FROM professor WHERE ID = '$ID' LIMIT 1");
...
<div class="col col-lg-H col-md-H col-sm-H haggy">
    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
			...
			<p> 	
	            <div class="divH"><label>Editar dados do Professor</label></div>      
	        </p> 
		</div>
		<div class="panel-body">
          <form class="form-horizontal"  method="POST" action="Instrutor-processa-editar.php">
